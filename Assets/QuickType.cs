...
//
//    Using version:            LDtk 0.7.2
//    QuickType generated with: https://app.quicktype.io/
//    QuickType JSON schema:    https://ldtk.io/files/JSON_SCHEMA.json
//    QuickType used for:       https://ldtk.io/ 
...
namespace QuickType
{
    ...
    public partial class LDtk
    {
        public static LDtk FromJson(string json) => JsonConvert.DeserializeObject<LDtk>(json, QuickType.Converter.Settings);
    }

    public static class Serialize
    {
        public static string ToJson(this LDtk self) => JsonConvert.SerializeObject(self, QuickType.Converter.Settings);
    }
